...
export function DataManagement({ onNotice }: DataManagementProps) {
  ...
  const accountCloudBackup = isAccountCloudBackup(cloudConfig);
      ...
      <div className="data-section">
        ...
        <div className="menu-group">
          <div className="menu-item data-readonly-item">
            ...
            <div className="menu-label-group">
              <span className="menu-label">{accountCloudBackup ? "账号云备份" : "备份到你的 Supabase"}</span>
              <span className="menu-desc">{accountCloudBackup ? "登录账号自动保存，可在其他设备恢复" : "云端备份与恢复"}</span>
            </div>
          </div>
